package com.microservices.organization.utils;
...
public class UserContext {
    ...
    public static final String AUTH_TOKEN     = "ms-auth-token";
    public static final String USER_ID        = "ms-user-id";
    public static final String ORG_ID         = "ms-org-id";
